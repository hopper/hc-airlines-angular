    ...
    return [
      ...
      },
      {
        ...
        description: `
          ...
          See <a target="_blank" aria-describedby="api documentation" href="https://airlines-api.staging.hopper.com/airline/v1.1/docs/index.html#operation/postCustomerCfar_offers">
            API documentation
          </a> <br />
