...
export class GlobalEventComponent extends GlobalComponent {
  ...
  protected initCfarExerciseEventParameters(
    hCSessionId: string,
  ...
  private isExerciseEventPossible(): boolean {
    if (
      ...
      this.eventHcSessionId !== undefined &&
      this.eventHcSessionId !== null &&
      this.cfarExerciseId !== undefined &&
      this.cfarExerciseId !== null
    ) {
      return true;
    }
    return false;
  ...
  protected createCfarExerciseVerificationCompleteEvent(
  ...
  protected createCfarExerciseCustomerDataCompleteEvent(
    exerciseStepResult: ExerciseStepResult,
  ): void {
    if (!this.isExerciseEventPossible) {
      return;
  ...
  protected createCfarExercisePortalCompleteEvent(
    exerciseStepResult: ExerciseStepResult,
  ): void {
    if (!this.isExerciseEventPossible) {
      return;
  ...
  protected createCfarExerciseCallbackLaunchedEvent(
    exerciseStepResult: ExerciseStepResult,
  ): void {
    if (!this.isExerciseEventPossible) {
      return;
