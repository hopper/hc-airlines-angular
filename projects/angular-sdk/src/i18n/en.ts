    ...
    data: {
        COMMON: {
            ...
            ERROR_CODE: {
                ...
                EV001: "User properties for the event could not be retrieved.", 
                EV002: "Platform properties for the event could not be retrieved.",
                EV003: "Trip properties for the event could not be retrieved.",
                EV004: "Fare properties for the event could not be retrieved.",
                EV005: "Offers properties for the event could not be retrieved.",
                EV006: "Purchase properties for the event could not be retrieved.",
                EV007: "Exercise properties for the event could not be retrieved."
            }
        },
        CFAR_OFFER_BANNER: {
